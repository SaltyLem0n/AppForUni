    ...
    public class PrizesController : Controller
    {
        ...
        public IActionResult Select()
        {
            ...
            var prizes = new List<(string PrizeName, string PrizeAmount)>
            {
                ...
                ("รางวัลที่ 5",  "เงินรางวัล 4,000 บาท"),
                ("รางวัลที่ 6",  "เงินรางวัล 3,000 บาท"),
                ("รางวัลที่ 7",  "เงินรางวัล 2,000 บาท"),
                ("รางวัลที่ 8",  "เงินรางวัล 1,500 บาท"),
                ("รางวัลที่ 9",  "เงินรางวัล 1,000 บาท"),
                ("รางวัลที่ 10", "เงินรางวัล 500 บาท"),
            };
